/* NOVUS LOVE v3 — Systemic Psychological Dynamics Engine added this */
(function () {
  "use strict";
  ...
  var F = {
    ...
    secureWithPartner: "Security with Partner",
    hope: "Hope",
    rejectionSensitivity: "Rejection Sensitivity",
    trustInPartner: "Trust in Partner",
    externalStress: "External Stress",
    selfExpectations: "Self-Expectations",
    ...
    sternIntimacy: "Emotional Intimacy",
  ...
  var TIP = {
    emotionRegulation:
      "Ability to manage emotional responses. Higher = calmer under pressure.",
    selfWorth:
      "Core sense of personal value. Low self-worth amplifies negative events.",
    ...
    rejectionSensitivity:
      "Tendency to overreact to rejection. Higher = more reactive.",
    trustInPartner: "Confidence in partner reliability and good intentions.",
    externalStress:
      "Pressure from outside the relationship. Reduces emotional bandwidth.",
    selfExpectations:
      "Standards held for own behavior. Very high = perfectionism.",
    health: "Overall psychological wellbeing composite score.",
    intimacy: "Emotional and physical closeness.",
    safety: "How protected each partner feels.",
    ...
    commitment:
      "Dedication to future. Satisfaction+Investment-Alternatives (Rusbult).",
    sternIntimacy:
      "Emotional closeness: warmth, sharing, understanding (Sternberg).",
  };
  ...
  var MBTI = {
    INTJ: {
      label: "Architect",
      ocean: { O: 78, C: 75, E: 28, A: 35, N: 45 },
      r: -0.02,
      w: 0.06,
      a: 0.03,
      g: 0.04,
      ...
      sr: 0.06,
      adp: 0.02,
      conflict: "Analyzes conflict logically. Withdraws to formulate position.",
    },
    INTP: {
      label: "Logician",
      ocean: { O: 82, C: 42, E: 32, A: 45, N: 52 },
      r: -0.01,
      w: 0.05,
      a: 0.01,
      g: 0.04,
      ...
      sr: 0.04,
      adp: 0.05,
      conflict: "Detaches emotionally to analyze.",
    },
    ENTJ: {
      label: "Commander",
      ocean: { O: 72, C: 82, E: 75, A: 32, N: 38 },
      r: 0.03,
      w: -0.02,
      a: 0.01,
      g: 0.05,
      ...
      sr: 0.05,
      adp: 0.03,
      conflict: "Confronts head-on with logic.",
    },
    ENTP: {
      label: "Debater",
      ocean: { O: 85, C: 38, E: 72, A: 42, N: 48 },
      r: 0.04,
      w: -0.03,
      a: 0.02,
      g: 0.05,
      ...
      sr: 0.02,
      adp: 0.06,
      conflict: "Reframes conflict as debate.",
    },
    INFJ: {
      label: "Advocate",
      ocean: { O: 78, C: 62, E: 30, A: 72, N: 58 },
      r: 0.03,
      w: 0.03,
      a: 0.06,
      g: 0.04,
      ...
      sr: 0.04,
      adp: 0.03,
      conflict: "Absorbs then processes internally.",
    },
    INFP: {
      label: "Mediator",
      ocean: { O: 82, C: 38, E: 28, A: 75, N: 65 },
      r: 0.04,
      w: 0.04,
      a: 0.05,
      g: 0.03,
      ...
      sr: 0.02,
      adp: 0.04,
      conflict: "Takes conflict personally.",
    },
    ENFJ: {
      label: "Protagonist",
      ocean: { O: 72, C: 65, E: 78, A: 82, N: 52 },
      r: 0.02,
      w: -0.04,
      a: 0.07,
      g: 0.04,
      ...
      sr: 0.03,
      adp: 0.04,
      conflict: "Mediates and restores harmony.",
    },
    ENFP: {
      label: "Campaigner",
      ocean: { O: 88, C: 35, E: 75, A: 72, N: 55 },
      r: 0.04,
      w: -0.03,
      a: 0.05,
      g: 0.04,
      ...
      sr: 0.01,
      adp: 0.06,
      conflict: "Emotionally expressive in conflict.",
    },
    ISTJ: {
      label: "Logistician",
      ocean: { O: 32, C: 85, E: 30, A: 48, N: 38 },
      r: -0.02,
      w: 0.03,
      a: 0.0,
      g: 0.01,
      ...
      sr: 0.07,
      adp: -0.02,
      conflict: "References precedent and rules.",
    },
    ISFJ: {
      label: "Defender",
      ocean: { O: 35, C: 78, E: 32, A: 82, N: 55 },
      r: 0.01,
      w: 0.02,
      a: 0.05,
      g: 0.01,
      ...
      sr: 0.06,
      adp: -0.01,
      conflict: "Avoids confrontation. May resent.",
    },
    ESTJ: {
      label: "Executive",
      ocean: { O: 35, C: 85, E: 72, A: 38, N: 35 },
      r: 0.02,
      w: -0.02,
      a: -0.01,
      g: 0.02,
      ...
      sr: 0.06,
      adp: -0.01,
      conflict: "Expects clear resolution.",
    },
    ESFJ: {
      label: "Consul",
      ocean: { O: 38, C: 72, E: 75, A: 85, N: 52 },
      r: 0.02,
      w: -0.03,
      a: 0.05,
      g: 0.01,
      ...
      sr: 0.04,
      adp: 0.0,
      conflict: "Seeks quick harmony.",
    },
    ISTP: {
      label: "Virtuoso",
      ocean: { O: 65, C: 45, E: 35, A: 35, N: 35 },
      r: -0.01,
      w: 0.04,
      a: -0.02,
      g: 0.03,
      ...
      sr: 0.04,
      adp: 0.05,
      conflict: "Stays calm and detached.",
    },
    ISFP: {
      label: "Adventurer",
      ocean: { O: 72, C: 38, E: 35, A: 72, N: 55 },
      r: 0.02,
      w: 0.03,
      a: 0.04,
      g: 0.02,
      ...
      sr: 0.02,
      adp: 0.04,
      conflict: "Withdraws quietly when hurt.",
    },
    ESTP: {
      label: "Entrepreneur",
      ocean: { O: 68, C: 38, E: 82, A: 38, N: 38 },
      r: 0.04,
      w: -0.04,
      a: -0.01,
      g: 0.03,
      ...
      sr: 0.01,
      adp: 0.06,
      conflict: "Pragmatic and direct.",
    },
    ESFP: {
      label: "Entertainer",
      ocean: { O: 72, C: 32, E: 85, A: 68, N: 48 },
      r: 0.03,
      w: -0.04,
      a: 0.03,
      g: 0.02,
      ...
      sr: 0.01,
      adp: 0.05,
      conflict: "Expresses emotions openly.",
    },
  };
  ...
  var ENNEA = {
    1: {
      ...
      sr: 0.05,
      adp: -0.02,
      pattern: "High standards for self and partner.",
    },
    2: {
      label: "Helper",
      r: 0.02,
      ...
      sr: 0.01,
      adp: 0.02,
      pattern: "Gives to receive. May lose identity.",
    },
    3: {
      label: "Achiever",
      r: 0.01,
    ...
    4: {
      ...
      sr: -0.01,
      adp: 0.02,
      pattern: "Intense depth. Push-pull.",
    },
    5: {
      label: "Investigator",
      r: -0.02,
      ...
      sr: 0.05,
      adp: 0.02,
      pattern: "Needs significant space.",
    },
    6: {
      label: "Loyalist",
      r: 0.04,
    ...
    7: {
      ...
      sr: -0.01,
      adp: 0.05,
      pattern: "Avoids uncomfortable emotions.",
    },
    8: {
      label: "Challenger",
      r: 0.06,
      ...
      sr: 0.02,
      adp: 0.01,
      pattern: "Protective but dominating.",
    },
    9: {
      label: "Peacemaker",
      r: -0.02,
  ...
  var ATT = {
    secure: {
      ...
      sr: 0.08,
      adp: 0.08,
      desc: "Comfortable with intimacy and autonomy.",
    },
    anxious: {
      ...
      sr: -0.06,
      adp: 0.02,
      desc: "Craves closeness. Hypervigilant to rejection.",
    },
    avoidant: {
      ...
      sr: 0.06,
      adp: -0.04,
      desc: "Values independence. Suppresses needs.",
    },
    fearful: {
      ...
      sr: -0.04,
      adp: -0.02,
      desc: "Desires closeness but fears rejection.",
    },
    disorganized: {
      label: "Disorganized",
      r: 0.14,
      ...
      sr: -0.08,
      adp: -0.06,
      desc: "Contradictory behaviors. Linked to trauma.",
    },
    "anxious-secure": {
      label: "Anxious-Secure Blend",
      r: 0.04,
      w: -0.02,
      a: 0.08,
      g: 0.06,
      ...
      sr: 0.02,
      adp: 0.04,
      desc: "Generally secure, anxious under stress.",
    },
    "avoidant-secure": {
      label: "Avoidant-Secure Blend",
      r: -0.04,
      w: 0.06,
      a: 0.04,
      g: 0.06,
      ...
      sr: 0.06,
      adp: 0.04,
      desc: "Secure but defaults to independence.",
    },
    "anxious-avoidant": {
      label: "Anxious-Avoidant Blend",
      r: 0.1,
      w: 0.06,
      a: -0.02,
      g: 0.0,
      ...
      sr: -0.04,
      adp: -0.02,
      desc: "Push-pull pattern.",
    },
    "fearful-anxious": {
      label: "Fearful-Anxious Blend",
      r: 0.12,
      w: 0.04,
      a: 0.0,
      g: -0.02,
      ...
      sr: -0.06,
      adp: -0.02,
      desc: "Fear of abandonment + fear of intimacy.",
    },
    "fearful-avoidant": {
      label: "Fearful-Avoidant Blend",
      r: 0.08,
      w: 0.1,
      a: -0.06,
      g: -0.02,
      ...
      sr: -0.02,
      adp: -0.04,
      desc: "Wants connection but distances when vulnerable.",
    },
    "earned-secure": {
      label: "Earned Secure",
      r: -0.04,
      ...
      sr: 0.06,
      adp: 0.08,
      desc: "Worked through insecurity. High growth.",
    },
  };
  ...
  var MH = {
    adhd: {
      label: "ADHD",
      severity: 3,
      selfTip: "Affects focus and impulse control.",
      partnerTip: "Partner may feel unheard.",
      relTip: "Missed bids for attention.",
      engTip: "Self-Regulation -3, Reactivity +2",
    },
    "social-anxiety": {
      label: "Social Anxiety",
      severity: 4,
      selfTip: "Fear of social judgment.",
      partnerTip: "Partner burdened as social buffer.",
      relTip: "Limits shared experiences.",
      engTip: "Expressiveness -3, Withdrawal +2",
    },
    autism: {
      label: "Autism Spectrum",
      severity: 3,
      selfTip: "Different social processing.",
      partnerTip: "May misread flat affect.",
      relTip: "Needs explicit communication.",
      engTip: "Expressiveness -3, Attunement -2",
    },
    gad: {
      label: "GAD",
      severity: 5,
      selfTip: "Persistent excessive worry.",
      partnerTip: "Constant reassurance needed.",
      relTip: "Chronic tension.",
      engTip: "Reactivity +4, Resilience -3",
    },
    ocd: {
      label: "OCD",
      severity: 5,
      selfTip: "Intrusive thoughts and compulsions.",
      partnerTip: "Drawn into rituals.",
      relTip: "Rigidity reduces flexibility.",
      engTip: "Adaptability -4, Self-Regulation stress +3",
    },
    panic: {
      label: "Panic Disorder",
      severity: 5,
      selfTip: "Sudden intense fear episodes.",
      partnerTip: "Helpless during attacks.",
      relTip: "Avoidance limits experiences.",
      engTip: "Reactivity +5, Resilience -3",
    },
    eating: {
      label: "Eating Disorder",
      severity: 5,
      selfTip: "Distorted body image.",
      partnerTip: "Shut out by secrecy.",
      relTip: "Secrecy erodes honesty.",
      engTip: "Self-Worth -4, Honesty -3",
    },
    depression: {
      label: "Depression",
      severity: 6,
      selfTip: "Low mood, fatigue, hopelessness.",
      partnerTip: "Bears increased load.",
      relTip: "Withdrawal cuts connection.",
      engTip: "Withdrawal +5, Hope -5",
    },
    rsd: {
      label: "RSD",
      severity: 5,
      selfTip: "Intense pain from perceived rejection.",
      partnerTip: "Walking on eggshells.",
      relTip: "Communication paralysis.",
      engTip: "Reactivity +5, Rejection Sensitivity +5",
    },
    ptsd: {
      label: "PTSD",
      severity: 7,
      selfTip: "Flashbacks, hypervigilance.",
      partnerTip: "May trigger responses.",
      relTip: "Unpredictable conflict.",
      engTip: "Reactivity +5, Withdrawal +4, Safety -4",
    },
    bipolar: {
      label: "Bipolar",
      severity: 7,
      selfTip: "Manic highs, depressive lows.",
      partnerTip: "Two different people.",
      relTip: "Instability in planning.",
      engTip: "Extreme Reactivity, Stability -5",
    },
    cptsd: {
      label: "C-PTSD",
      severity: 8,
      selfTip: "Identity fragmentation from prolonged trauma.",
      partnerTip: "Projection and sudden shifts.",
      relTip: "Attachment deeply disrupted.",
      engTip: "Severe across all dimensions",
    },
    substance: {
      label: "Substance Use",
      severity: 7,
      selfTip: "Alters personality and reliability.",
      partnerTip: "Becomes caretaker.",
      relTip: "Destroys safety.",
      engTip: "All positive metrics -4 to -6",
    },
    bpd: {
      label: "BPD",
      severity: 8,
      selfTip: "Fear of abandonment, splitting.",
      partnerTip: "Idealization-devaluation cycles.",
      relTip: "Intense but unstable.",
      engTip: "Maximum Reactivity, severe Resilience loss",
    },
    npd: {
      label: "NPD",
      severity: 7,
      selfTip: "Grandiosity masking fragile worth.",
      partnerTip: "Needs deprioritized.",
      relTip: "One-directional.",
      engTip: "Partner Safety -6, Attunement -5",
    },
    did: {
      label: "DID",
      severity: 9,
      selfTip: "Multiple identity states.",
      partnerTip: "Different presentations.",
      relTip: "Consistency challenging.",
      engTip: "Extreme variability all dimensions",
    },
    schizophrenia: {
      label: "Schizophrenia",
      severity: 9,
      selfTip: "Distorted reality.",
      partnerTip: "Symptoms vs intent confusion.",
      relTip: "Shared reality compromised.",
      engTip: "Severe all-dimension reduction",
    },
    aspd: {
      label: "ASPD",
      severity: 8,
      selfTip: "Disregard for norms, manipulation.",
      partnerTip: "Risk of exploitation.",
      relTip: "Genuine mutuality impossible.",
      engTip: "Attunement near zero",
    },
    psychopathy: {
      label: "Psychopathy",
      severity: 8,
      selfTip: "Callous traits, no empathy.",
      partnerTip: "Instrumentalized.",
      relTip: "Not mutual.",
      engTip: "Maximum negative impact",
    },
    szpd: {
      label: "SzPD",
      severity: 6,
      selfTip: "Pervasive detachment.",
      partnerTip: "Emotionally alone.",
      relTip: "Emotional desert.",
      engTip: "Max Withdrawal, Expressiveness near floor",
    },
  };
  var MH_ORDER = [
    "adhd",
  ...
  function classifySternberg(i, p, c) {
    ...
    if (!hi(i) && !hi(p) && !hi(c))
      return {
        type: "Non-Love",
        desc: "No significant components present.",
        color: "#888",
      };
    if (hi(i) && !hi(p) && !hi(c))
      return {
        type: "Liking",
        desc: "Closeness without passion or commitment.",
        color: "#8ecae6",
      };
    if (!hi(i) && hi(p) && !hi(c))
      return {
        type: "Infatuation",
        desc: "Passion without depth or commitment.",
        color: "#e63946",
      };
    if (!hi(i) && !hi(p) && hi(c))
      return {
        type: "Empty Love",
        desc: "Commitment without warmth or desire.",
        color: "#adb5bd",
      };
    if (hi(i) && hi(p) && !hi(c))
      return {
        type: "Romantic Love",
        desc: "Passion and intimacy without commitment.",
        color: "#f4a261",
      };
    if (hi(i) && !hi(p) && hi(c))
      return {
        type: "Companionate Love",
        desc: "Deep bond without passion.",
        color: "#2a9d8f",
      };
    if (!hi(i) && hi(p) && hi(c))
      return {
        type: "Fatuous Love",
        desc: "Commitment driven by passion, lacking depth.",
        color: "#e76f51",
      };
    return {
      type: "Consummate Love",
      desc: "All three components strong. Ideal.",
      color: "#06d6a0",
    };
  }

  // ── RUSBULT INVESTMENT MODEL ── Weight: 0.08
  function calcRusbultSatisfaction(rel) {
    return clamp((rel.intimacy + rel.connection + rel.honesty) / 3, 0, 1);
  }
  function calcRusbultInvestment(rel, a, b) {
    return clamp(
      (rel.bond +
        rel.meaning +
        (1 - a.rejectionSensitivity) +
        (1 - b.rejectionSensitivity)) /
        4,
      0,
      1,
    );
  }
  function calcRusbultAlternatives(a, b) {
    return clamp(1 - (a.trustInPartner + b.trustInPartner) / 2, 0, 1);
  }
  function calcRusbultCommitment(sat, inv, alt) {
    return clamp(sat + inv - alt, 0, 1);
  }
  ...
  function calcBowen(p) {
    ...
    var fusion = clamp(
      1 - (p.rejectionSensitivity + p.externalStress) / 2,
      0,
      1,
    );
  ...
  var LL_COMPAT = {};
  LL_LIST.forEach(function (a) {
    LL_COMPAT[a] = {};
    LL_LIST.forEach(function (b) {
      LL_COMPAT[a][b] = a === b ? 1.0 : 0.5;
    });
  });
  LL_COMPAT["words"]["acts"] = 0.7;
  LL_COMPAT["acts"]["words"] = 0.7;
  LL_COMPAT["time"]["touch"] = 0.7;
  LL_COMPAT["touch"]["time"] = 0.7;
  LL_COMPAT["gifts"]["acts"] = 0.6;
  LL_COMPAT["acts"]["gifts"] = 0.6;
  ...
  var PRACTICES = [
    {
      ...
      effects: { emotionRegulation: 0.02, secureWithPartner: 0.03 },
      partnerEffects: { secureWithPartner: 0.03, trustInPartner: 0.02 },
      relEffects: { trust: 0.03, connection: 0.03, intimacy: 0.02 },
    },
    {
      id: "gratitude",
      label: "Express Gratitude",
      effects: { selfWorth: 0.02, hope: 0.02 },
      partnerEffects: { selfWorth: 0.03, secureWithPartner: 0.02 },
      relEffects: { bond: 0.02, connection: 0.03, honesty: 0.01 },
    },
    {
      id: "repair",
      label: "Repair Attempt",
      effects: { emotionRegulation: 0.02, hope: 0.03 },
      partnerEffects: { secureWithPartner: 0.04, trustInPartner: 0.03 },
      relEffects: { trust: 0.04, safety: 0.03, tension: -0.04 },
    },
    {
      id: "vulnerability",
      label: "Share Vulnerability",
      effects: { selfWorth: 0.01, secureWithPartner: 0.02 },
      partnerEffects: { secureWithPartner: 0.03, trustInPartner: 0.02 },
      relEffects: { intimacy: 0.04, honesty: 0.03, bond: 0.03 },
    },
    {
      id: "boundary",
      label: "Set Healthy Boundary",
      effects: {
        emotionRegulation: 0.03,
        selfWorth: 0.03,
        selfExpectations: -0.01,
      },
      partnerEffects: { secureWithPartner: 0.01 },
      relEffects: { safety: 0.03, honesty: 0.02, stability: 0.02 },
    },
    {
      id: "quality-time",
      label: "Quality Time",
      effects: { hope: 0.02, secureWithPartner: 0.02 },
      partnerEffects: { secureWithPartner: 0.02, hope: 0.02 },
      relEffects: { connection: 0.04, intimacy: 0.03, bond: 0.02 },
    },
    {
      id: "mindfulness",
      label: "Mindfulness Together",
      effects: { emotionRegulation: 0.04, externalStress: -0.03 },
      partnerEffects: { emotionRegulation: 0.02 },
      relEffects: { stability: 0.02, tension: -0.03 },
    },
    {
      id: "dream-share",
      label: "Share Dreams & Goals",
      effects: { hope: 0.03, selfWorth: 0.01 },
      partnerEffects: { hope: 0.02, secureWithPartner: 0.02 },
      relEffects: { meaning: 0.04, growth: 0.03, commitment: 0.02 },
    },
    {
      id: "physical",
      label: "Physical Affection",
      effects: { secureWithPartner: 0.03 },
      partnerEffects: { secureWithPartner: 0.03 },
      relEffects: { intimacy: 0.03, passion: 0.03, bond: 0.02 },
    },
    {
      id: "apology",
      label: "Genuine Apology",
      effects: { selfWorth: 0.01, emotionRegulation: 0.02 },
      partnerEffects: { secureWithPartner: 0.04, trustInPartner: 0.04 },
      relEffects: { trust: 0.05, safety: 0.04, tension: -0.05, honesty: 0.03 },
    },
    {
      id: "support",
      label: "Emotional Support",
      effects: { secureWithPartner: 0.02 },
      partnerEffects: { selfWorth: 0.03, hope: 0.03, secureWithPartner: 0.04 },
      relEffects: { bond: 0.03, safety: 0.03, connection: 0.02 },
    },
    {
      id: "celebrate",
      label: "Celebrate Success",
      effects: { selfWorth: 0.02, hope: 0.02 },
      partnerEffects: { selfWorth: 0.03, hope: 0.02 },
      relEffects: { connection: 0.03, meaning: 0.02, growth: 0.02 },
    },
  ];
  ...
  var TOXICS = [
    {
      ...
      effects: { selfWorth: -0.01, emotionRegulation: -0.02 },
      partnerEffects: { selfWorth: -0.05, secureWithPartner: -0.04 },
      relEffects: { trust: -0.04, safety: -0.04, tension: 0.05 },
    },
    {
      id: "contempt",
      label: "Show Contempt",
      effects: { selfWorth: 0.01 },
      partnerEffects: {
        selfWorth: -0.06,
        secureWithPartner: -0.06,
        hope: -0.05,
      },
      relEffects: { trust: -0.06, bond: -0.05, safety: -0.06, tension: 0.06 },
    },
    {
      id: "stonewall",
      label: "Stonewall Partner",
      effects: { emotionRegulation: -0.02 },
      partnerEffects: { secureWithPartner: -0.05, hope: -0.04 },
      relEffects: {
        connection: -0.06,
        intimacy: -0.04,
        trust: -0.03,
    ...
    {
      id: "dismiss",
      label: "Dismiss Feelings",
      effects: {},
      partnerEffects: {
        selfWorth: -0.04,
        secureWithPartner: -0.04,
        hope: -0.03,
      },
      relEffects: {
        intimacy: -0.04,
    ...
    },
    {
      id: "betray",
      label: "Betray Trust",
      effects: { selfWorth: -0.02 },
      partnerEffects: {
        trustInPartner: -0.08,
        secureWithPartner: -0.07,
        hope: -0.06,
      },
      relEffects: {
        trust: -0.1,
  ...
  var ATT_COMBO = {
    "secure+secure": {
      label: "Secure Haven",
      risk: 0.05,
      dynamics: "Mutual safety, strong repair, high resilience.",
    },
    "secure+anxious": {
      label: "Calming Anchor",
      risk: 0.2,
      dynamics: "Secure partner soothes anxiety; protest behavior may arise.",
    },
    "secure+avoidant": {
      label: "Patient Bridge",
      risk: 0.25,
      dynamics:
        "Secure partner models closeness; avoidant may withdraw under pressure.",
    },
    "secure+fearful": {
      label: "Stabilizing Force",
      risk: 0.3,
      dynamics: "Secure partner provides consistency; fearful may oscillate.",
    },
    "secure+disorganized": {
      label: "Grounding Presence",
      risk: 0.35,
      dynamics:
        "Secure partner absorbs chaos; disorganized needs high patience.",
    },
    "anxious+anxious": {
      label: "Intensity Loop",
      risk: 0.5,
      dynamics:
        "High emotional intensity, mutual reassurance-seeking, escalation risk.",
    },
    "anxious+avoidant": {
      label: "Pursuit-Distance Trap",
      risk: 0.65,
      dynamics: "Classic anxious-avoidant trap: one pursues, one retreats.",
    },
    "anxious+fearful": {
      label: "Volatile Connection",
      risk: 0.6,
      dynamics: "Intense bond with frequent ruptures and desperate repair.",
    },
    "anxious+disorganized": {
      label: "Chaos Spiral",
      risk: 0.7,
      dynamics: "Unpredictable cycles of closeness and crisis.",
    },
    "avoidant+avoidant": {
      label: "Parallel Orbits",
      risk: 0.45,
      dynamics:
        "Comfortable distance but emotional desert; low conflict, low intimacy.",
    },
    "avoidant+fearful": {
      label: "Approach-Retreat",
      risk: 0.55,
      dynamics: "Fearful craves what avoidant withholds; painful push-pull.",
    },
    "avoidant+disorganized": {
      label: "Disconnected",
      risk: 0.6,
      dynamics: "Both struggle with closeness; emotional isolation likely.",
    },
    "fearful+fearful": {
      label: "Mutual Minefield",
      risk: 0.7,
      dynamics: "Both want and fear intimacy; high rupture frequency.",
    },
    "fearful+disorganized": {
      label: "Destabilized",
      risk: 0.75,
      dynamics: "Neither can provide safety; professional support essential.",
    },
    "disorganized+disorganized": {
      label: "Storm Pattern",
      risk: 0.85,
      dynamics: "Maximum unpredictability; cycle of crisis and repair.",
    },
    "anxious-secure+avoidant-secure": {
      label: "Healing Bridge",
      risk: 0.2,
      dynamics:
        "Both trending secure; growth-oriented with occasional old patterns.",
    },
    "earned-secure+anxious": {
      label: "Learned Safety",
      risk: 0.25,
      dynamics:
        "Earned-secure models regulation; anxious benefits from stability.",
    },
    "earned-secure+avoidant": {
      label: "Gradual Opening",
      risk: 0.3,
      dynamics:
        "Earned-secure demonstrates vulnerability; avoidant may slowly open.",
    },
    "codependent+anxious": {
      label: "Enmeshed Bind",
      risk: 0.6,
      dynamics: "Excessive merger; individual identity erodes.",
    },
    "codependent+avoidant": {
      label: "Suffocating Gap",
      risk: 0.65,
      dynamics: "Codependent clings, avoidant suffocates; toxic cycle.",
    },
    "codependent+codependent": {
      label: "Total Fusion",
      risk: 0.7,
      dynamics: "Complete enmeshment; no individual boundaries.",
    },
    "codependent+secure": {
      label: "Boundary Teacher",
      risk: 0.35,
      dynamics:
        "Secure models healthy separation; codependent learns autonomy.",
    },
  };
  function getAttCombo(a, b) {
    ...
    return (
      ...
      ATT_COMBO[key2] || {
        ...
        risk: 0.4,
        dynamics:
          "A less-studied pairing; outcomes depend on individual growth.",
      }
    );
  }
  ...
  ATT["codependent"] = {
    ...
    sr: -0.05,
    adp: -0.04,
    desc: "Over-fused identity; sacrifices self for partner stability.",
  };
  ...
  var INTERACTIONS = {
    Affection: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Warm embrace after long day", int: 0.5 },
        { label: "Surprise love note", int: 0.4 },
        { label: "Held hands on walk", int: 0.35 },
        { label: "Forehead kiss before sleep", int: 0.3 },
        { label: "Said I love you unprompted", int: 0.45 },
      ],
      base: {
        trust: 0.03,
        bond: 0.05,
    ...
    "Quality Time": {
      ...
      defaultInt: 0.45,
      scenarios: [
        { label: "Cooked a meal together", int: 0.4 },
        { label: "Had a deep conversation", int: 0.5 },
        { label: "Played a game together", int: 0.35 },
        { label: "Went for a sunset walk", int: 0.4 },
        { label: "Shared a new hobby", int: 0.45 },
      ],
      base: {
        bond: 0.04,
        connection: 0.05,
    ...
    Support: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Listened without fixing", int: 0.5 },
        { label: "Helped with stressful task", int: 0.4 },
        { label: "Defended partner to others", int: 0.55 },
        { label: "Showed up during crisis", int: 0.65 },
        { label: "Validated feelings", int: 0.45 },
      ],
      base: {
        trust: 0.04,
        bond: 0.04,
    ...
    Growth: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Shared a vulnerable fear", int: 0.55 },
        { label: "Set a boundary respectfully", int: 0.45 },
        { label: "Tried partner's suggestion", int: 0.4 },
        { label: "Attended couples workshop", int: 0.5 },
        { label: "Discussed future goals", int: 0.45 },
      ],
      base: {
        trust: 0.03,
        bond: 0.03,
      ...
      selfBase: {
        selfWorth: 0.03,
        hope: 0.03,
        emotionRegulation: 0.02,
        selfExpectations: 0.02,
      },
      partnerBase: {
        secureWithPartner: 0.03,
        trustInPartner: 0.02,
    ...
    Intimacy: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Shared a fantasy openly", int: 0.5 },
        { label: "Initiated physical closeness", int: 0.45 },
        { label: "Eye contact during vulnerability", int: 0.55 },
        { label: "Cried together", int: 0.6 },
        { label: "Expressed a deep need", int: 0.5 },
      ],
      base: {
        bond: 0.05,
        intimacy: 0.06,
    ...
    Repair: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Apologized sincerely", int: 0.5 },
        { label: "Acknowledged their perspective", int: 0.45 },
        { label: "Offered a compromise", int: 0.4 },
        { label: "Took responsibility", int: 0.55 },
        { label: "Asked how to fix this", int: 0.45 },
      ],
      base: {
        trust: 0.05,
        bond: 0.04,
    ...
    "Daily Life": {
      ...
      defaultInt: 0.3,
      scenarios: [
        { label: "Morning coffee together", int: 0.25 },
        { label: "Coordinated schedules", int: 0.25 },
        { label: "Handled logistics smoothly", int: 0.3 },
        { label: "Managed kids as team", int: 0.35 },
        { label: "Shared a meal at home", int: 0.25 },
      ],
      base: {
        bond: 0.02,
        connection: 0.02,
    ...
    Boundary: {
      ...
      defaultInt: 0.4,
      scenarios: [
        { label: "Set a clear boundary", int: 0.45 },
        { label: "Respected partner's no", int: 0.4 },
        { label: "Discussed needs vs wants", int: 0.4 },
        { label: "Renegotiated agreement", int: 0.35 },
        { label: "Pushed past a stated limit", int: 0.5 },
      ],
      base: {
        safety: 0.03,
        trust: 0.03,
    ...
    "External Stress": {
      ...
      defaultInt: 0.6,
      scenarios: [
        { label: "Major life transition", int: 0.5 },
        { label: "Financial setback", int: 0.55 },
        { label: "Family emergency", int: 0.65 },
        { label: "Health scare", int: 0.7 },
        { label: "Job loss announced", int: 0.6 },
      ],
    ...
    Neglect: {
      ...
      defaultInt: 0.4,
      scenarios: [
        { label: "Chose phone over conversation", int: 0.3 },
        { label: "Skipped planned date night", int: 0.4 },
        { label: "Forgot important date", int: 0.45 },
        { label: "Dismissed partner's feelings", int: 0.5 },
        { label: "Ignored bid for attention", int: 0.4 },
      ],
      base: {
        bond: -0.03,
        connection: -0.04,
    ...
    Conflict: {
      ...
      defaultInt: 0.5,
      scenarios: [
        { label: "Disagreed about finances", int: 0.45 },
        { label: "Argued about chores", int: 0.4 },
        { label: "Brought up old grievance", int: 0.55 },
        { label: "Criticized partner's decision", int: 0.5 },
        { label: "Raised voice", int: 0.65 },
      ],
      base: {
        trust: -0.03,
        bond: -0.02,
    ...
    Betrayal: {
      ...
      defaultInt: 0.75,
      scenarios: [
        { label: "Shared private info with others", int: 0.6 },
        { label: "Broke a significant promise", int: 0.65 },
        { label: "Financial deception revealed", int: 0.75 },
        { label: "Discovered a hidden lie", int: 0.8 },
        { label: "Emotional affair", int: 0.9 },
      ],
      base: {
        trust: -0.08,
        bond: -0.05,
      ...
      partnerBase: {
        ...
        selfWorth: -0.05,
        hope: -0.05,
        rejectionSensitivity: 0.05,
        emotionRegulation: -0.04,
      },
    },
  };
  // ── ENGINE STATE ──
  var S = {
    ...
    a: {
      ...
      mood: "neutral",
      support: 50,
      ocean: { O: 0.7, C: 0.6, E: 0.4, A: 0.55, N: 0.45 },
      mh: {},
      emotionRegulation: 0.6,
      selfWorth: 0.55,
      secureWithPartner: 0.5,
      hope: 0.55,
      rejectionSensitivity: 0.4,
      trustInPartner: 0.5,
      externalStress: 0.35,
      selfExpectations: 0.5,
      health: 0.55,
      intimacy: 0.5,
    },
    b: {
      ...
      mood: "calm",
      support: 50,
      ocean: { O: 0.75, C: 0.45, E: 0.7, A: 0.65, N: 0.55 },
      mh: {},
      emotionRegulation: 0.6,
      selfWorth: 0.55,
      secureWithPartner: 0.5,
    ...
    driftA: { score: 0, dir: "none" },
    driftB: { score: 0, dir: "none" },
    evtCount: 0,
    history: [],
    undoStack: [],
    snapshot: null,
  ...
  function savePrev(who) {
    var p = S[who];
    p._prev = clone({
      emotionRegulation: p.emotionRegulation,
      selfWorth: p.selfWorth,
      secureWithPartner: p.secureWithPartner,
      hope: p.hope,
      rejectionSensitivity: p.rejectionSensitivity,
      trustInPartner: p.trustInPartner,
      externalStress: p.externalStress,
      selfExpectations: p.selfExpectations,
      health: p.health,
      intimacy: p.intimacy,
    });
  }

  function saveRelPrev() {
    S.rel._prev = clone(S.rel);
  }
  ...
  function pushUndo() {
    S.undoStack.push(
      clone({
        ...
        b: S.b,
        rel: S.rel,
        sentHistory: S.sentHistory,
        behCounts: S.behCounts,
        conflictLvl: S.conflictLvl,
        repairWin: S.repairWin,
        driftA: S.driftA,
        driftB: S.driftB,
        evtCount: S.evtCount,
        log: S.log,
  ...
  function doUndo() {
    ...
    S.b = snap.b;
    S.rel = snap.rel;
    S.sentHistory = snap.sentHistory;
    S.behCounts = snap.behCounts;
    S.conflictLvl = snap.conflictLvl;
    S.repairWin = snap.repairWin;
    S.driftA = snap.driftA;
    S.driftB = snap.driftB;
    S.evtCount = snap.evtCount;
    S.log = snap.log;
    S.logA = snap.logA;
    S.logB = snap.logB;
    renderAll();
    addLog("Undo performed.", "rel");
  }

  function saveSnap() {
    S.snapshot = clone({ a: S.a, b: S.b, rel: S.rel });
  }
  // ── PSO / NSO ──
  function calcPSO() {
    var h = S.sentHistory.slice(-20);
    if (h.length < 3) return { mode: "neutral", ratio: 0.5 };
    var pos = 0;
    for (var i = 0; i < h.length; i++) {
      if (h[i] > 0) pos++;
    }
    var ratio = pos / h.length;
    if (ratio >= 0.6) return { mode: "positive", ratio: ratio };
    if (ratio <= 0.4) return { mode: "negative", ratio: ratio };
    return { mode: "neutral", ratio: ratio };
  }
  function applyPSO(val, isNeg) {
    var pso = calcPSO();
    if (pso.mode === "positive" && isNeg) return val * 0.8;
    if (pso.mode === "negative" && isNeg) return val * 1.2;
    if (pso.mode === "negative" && !isNeg) return val * 0.8;
    return val;
  }

  // ── REPAIR WINDOW ──
  function openRepair(label) {
    S.repairWin = { active: true, remaining: 3, trigger: label };
  }
  function checkRepair(isRepair) {
    if (!S.repairWin.active) return 1.0;
    if (isRepair) {
      S.repairWin.active = false;
      S.repairWin.remaining = 0;
      return 2.0;
    }
    S.repairWin.remaining--;
    if (S.repairWin.remaining <= 0) {
      S.repairWin.active = false;
    }
    return 1.0;
  }
  ...
  // ── CONFLICT LEVEL ──
  function updateConflict(delta) {
    S.conflictLvl = clamp((S.conflictLvl || 0) + delta, 0, 6);
  }

  // ── AUTO-MOOD ──
  function autoMood(who, isNeg) {
    var p = S[who];
    if (p.health < 0.2) p.mood = "depressed";
    else if (p.health < 0.35 && isNeg) p.mood = "anxious";
    else if (p.health > 0.8 && !isNeg) p.mood = "content";
  }
  ...
  function calcRadar(who) {
    var p = S[who];
    var mbti = MBTI[p.mbti] || {};
    var enn = ENNEA[p.ennea] || {};
    var att = ATT[p.attach] || {};
    var mood = MOOD[p.mood] || {};
    var o = p.ocean;
    var result = {};
  ...
  function calcLLBonus(actor, receiver, cat) {
    ...
    if (cat === "Affection" && (lb === "touch" || lb === "words"))
      return prox * 0.03;
  ...
  function processInteraction(dir, catKey, scenIdx, intensity) {
    ...
    var finMod = FIN_ALIGN[S.finAlign] || {
      trust: 0,
      tension: 0,
      stability: 0,
    };
    ...
    // Self impact
    if (cat.selfBase) {
      var sk = Object.keys(cat.selfBase);
    ...
    S[actor].externalStress = cl(
      S[actor].externalStress + (lifeMod.stress || 0) * 0.005,
    );

    // Partner impact
    if (cat.partnerBase) {
      var pk = Object.keys(cat.partnerBase);
    ...
    if (isNeg) {
      if (cs.tension)
        S.rel.tension = cl(S.rel.tension + cs.tension * intensity);
      if (cs.trust) S.rel.trust = cl(S.rel.trust + cs.trust * intensity);
      if (cs.safety)
        S.rel.safety = cl(S.rel.safety + (cs.safety || 0) * intensity);
    }
    ...
    autoMood(actor, isNeg);
    autoMood(receiver, isNeg);
    S.evtCount++;
    ...
    addLog(
      dirLabel + ": " + label + " [" + catKey + "] @" + pct(intensity) + "%",
      "rel",
    );
  ...
  function meterHTML(id, label, tip) {
    return (
      '<div class="meter" id="wrap_' +
      id +
      '">' +
      '<div class="meter-label"><span data-tip="' +
      (tip || "") +
      '" style="cursor:help">' +
      label +
      "</span>" +
      '<span class="meter-val" id="val_' +
      id +
      '">0</span></div>' +
      '<div class="meter-track"><div class="meter-fill" id="fill_' +
      id +
      '"></div></div></div>'
    );
  }
  ...
  function setMeter(id, val) {
    ...
    if (
      id.indexOf("Tension") >= 0 ||
      id.indexOf("Friction") >= 0 ||
      id.indexOf("rejSens") >= 0 ||
      id.indexOf("stress") >= 0
    ) {
      color =
        p <= 30
  ...
  function renderRadar(containerId, who) {
    ...
    for (var i = 0; i < n; i++) {
      ...
      svg +=
        ...
        '" y="' +
        rnd(ly, 0) +
        '" fill="var(--dim)" font-size="8" text-anchor="' +
        anchor +
      ...
      var pv = v;
      pts.push([
        cx + Math.cos(ang) * maxR * pv,
        cy + Math.sin(ang) * maxR * pv,
      ]);
    }
    // Polygon
    var poly = "";
    for (var i = 0; i < pts.length; i++)
      poly += rnd(pts[i][0], 1) + "," + rnd(pts[i][1], 1) + " ";
    svg +=
      '<polygon points="' +
      poly +
      '" fill="rgba(88,166,255,0.12)" stroke="var(--accent)" stroke-width="2"/>';
    for (var i = 0; i < pts.length; i++) {
      svg +=
        '<circle cx="' +
        rnd(pts[i][0], 1) +
  ...
  function renderIndMetrics(who) {
    ...
    if (dosEl) {
      var bw = calcBowen(p);
      var bl = bowenLabel(bw.dos);
      dosEl.innerHTML =
        "<strong>Differentiation:</strong> " + bl + " (" + pct(bw.dos) + "%)";
    }
    // Drift
    var drEl = $("drift" + s);
    if (drEl) {
      var dk = who === "a" ? S.driftA : S.driftB;
      if (dk.score !== 0)
        drEl.innerHTML =
          "Attachment drift: <strong>" +
          dk.dir +
          "</strong> (" +
          rnd(dk.score, 1) +
          ")";
    ...
    if (seEl) {
      ...
      seEl.innerHTML =
        "Weighted sentiment: <strong>" + lbl + "</strong> (" + rnd(ws, 2) + ")";
    }
  }
  ...
  function renderRelMetrics() {
    var r = S.rel;
    setMeter("rSafety", r.safety);
    setMeter("rTrust", r.trust);
    setMeter("rBond", r.bond);
    setMeter("rConn", r.connection);
    setMeter("rMeaning", r.meaning);
    setMeter("rHonesty", r.honesty);
    setMeter("rStab", r.stability);
    setMeter("rIntim", r.intimacy);
    setMeter("rGrowth", r.growth);
    setMeter("rTension", r.tension);
    setMeter("rFriction", r.friction);
    setMeter("rPassion", r.passion);
    setMeter("rCommit", r.commitment);
    setMeter("rSternInt", r.sternIntimacy);
    setMeter("rOverall", r.overall);

    // Status tier
    var stEl = $("relStatus");
    if (stEl) {
      var t = getTier(r.overall, REL_TIERS);
      stEl.innerHTML =
    ...
    if (stbEl) {
      ...
      stbEl.innerHTML =
        "<strong>Love Type:</strong> <span style='color:" +
        st.color +
        "'>" +
        st.type +
        "</span><br><small>" +
    ...
    if (ruEl) {
      ...
      var alt = calcRusbultAlternatives(S.a, S.b);
      ruEl.innerHTML =
        "<strong>Investment Model:</strong> Sat: " +
        pct(sat) +
        "% | Inv: " +
        pct(inv) +
        "% | Alt: " +
    ...
    if (psoEl) {
      ...
      psoEl.innerHTML =
        ...
        lbl +
        "</span> (" +
        Math.round(pso.ratio * 100) +
        "% positive)";
    }
    // Repair window
    var repEl = $("repairBox");
    if (repEl) {
      if (S.repairWin.active)
        repEl.innerHTML =
          "<span style='color:var(--yellow)'>⚠ Repair Window: " +
          S.repairWin.remaining +
          " events left</span>";
    ...
    if (confEl) {
      if (S.conflictLvl > 0) {
        ...
        confEl.innerHTML =
          "Conflict: <strong>" +
          labels[Math.min(Math.round(S.conflictLvl), 6)] +
          "</strong> (" +
          Math.round(S.conflictLvl) +
          "/6)";
  ...
  function renderStory(who) {
    ...
    h +=
      ...
      "%)";
    h +=
      "<br>Differentiation: " + bowenLabel(bw.dos) + " (" + pct(bw.dos) + "%)";
    h += "<br><strong>Radar:</strong> ";
    for (var i = 0; i < DIM_KEYS.length; i++) {
      h += DIM_LABELS[i] + ":" + pct(radar[DIM_KEYS[i]]) + "%";
      if (i < 7) h += " · ";
    }
  ...
  function renderNarrative() {
    ...
    if (!el) return;
    if (!S.evtCount) {
      el.innerHTML = "Run the engine to generate narrative.";
      return;
    }
    var r = S.rel;
    var tier = getTier(r.overall, REL_TIERS);
    var pso = calcPSO();
    ...
    var h =
      ...
      "%)";
    h +=
      "<br><strong>Dynamic:</strong> " + combo.label + " — " + combo.dynamics;
    h += "<br><strong>Love Type:</strong> " + st.type + " — " + st.desc;
    h += "<br><strong>Climate:</strong> ";
    if (pso.mode === "positive")
      h += "Positive Override active — negatives buffered 20%.";
    else if (pso.mode === "negative")
      h += "Negative Override active — negatives amplified 20%.";
    else h += "Neutral climate.";
    h += "<br><strong>Key Dynamics:</strong><br>";
    if (r.trust < 0.4)
      h +=
        "• Trust critically low (" +
        pct(r.trust) +
        "%). Needs consistent positive actions.<br>";
    if (r.tension > 0.6)
      h += "• High tension (" + pct(r.tension) + "%) amplifying negatives.<br>";
    if (r.safety < 0.4)
      h += "• Safety compromised (" + pct(r.safety) + "%).<br>";
    if (r.passion < 0.3)
      h += "• Passion faded (" + pct(r.passion) + "%). Needs novelty.<br>";
    if (r.bond > 0.7)
      h += "• Strong bond (" + pct(r.bond) + "%) provides resilience.<br>";
    if (r.commitment > 0.75)
      h +=
        "• Strong commitment (" +
        pct(r.commitment) +
        "%) holds through difficulty.<br>";
    if (S.conflictLvl > 3)
      h +=
        "• Conflict at level " +
        Math.round(S.conflictLvl) +
        ". De-escalation urgent.<br>";
    if (S.repairWin.active)
      h += "• ⚠ Repair window open — repairs now are 2x effective!<br>";
    el.innerHTML = h;
  }
  ...
  function renderRecs() {
    ...
    if (!el) return;
    if (!S.evtCount) {
      el.innerHTML = "Run the engine to generate recommendations.";
      return;
    }
    var recs = [];
    var r = S.rel;
    if (r.trust < 0.5)
      recs.push(
        "🔒 Trust below 50%. Focus on small, consistent positive actions.",
      );
    if (r.tension > 0.5)
      recs.push(
        "🌡 Tension at " +
          pct(r.tension) +
          "%. Use Time-Out Protocol, then Repair.",
      );
    if (r.safety < 0.5)
      recs.push(
        "🛡 Safety needs work. Validate feelings before problem-solving.",
      );
    if (r.intimacy < 0.4)
      recs.push("💞 Intimacy low. Schedule device-free Quality Time.");
    if (r.passion < 0.3)
      recs.push("🔥 Passion faded. Prioritize novelty and physical closeness.");
    if (S.conflictLvl > 3)
      recs.push(
        "⚡ High conflict. Both partners: Box Breathing before discussions.",
      );
    if (S.a.externalStress > 0.6 || S.b.externalStress > 0.6)
      recs.push(
        "🏔 External stress high. Prioritize individual Resilience Practices.",
      );
    if (S.a.selfWorth < 0.4 || S.b.selfWorth < 0.4)
      recs.push(
        "💎 Low Self-Worth detected. Self-Compassion Break recommended.",
      );
    var pso = calcPSO();
    if (pso.mode === "negative")
      recs.push(
        "📊 Negative Override active. Need 5:1 positive-to-negative ratio.",
      );
    if (S.repairWin.active)
      recs.push("🔧 Repair window open! Repair now = 2x effective.");
    if (r.commitment < 0.4)
      recs.push(
        "🤝 Commitment low. Discuss shared goals and increase investment.",
      );
    if (!recs.length)
      recs.push(
        "✨ Relationship in good shape. Keep investing in appreciation and quality time.",
      );
  ...
  function renderTimeline() {
    ...
    if (S.history.length < 2) {
      el.innerHTML =
        '<div style="color:var(--dim)">Process events to build timeline.</div>';
      return;
    }
    var w = 500,
      h = 80,
    ...
    for (var g = 0; g <= 100; g += 25) {
      ...
      svg +=
        ...
        '" y="' +
        gy +
        '" fill="var(--dim)" font-size="7" text-anchor="end" dominant-baseline="middle">' +
        g +
        "</text>";
    }
    // Lines
    var lines = [
      { key: "relHealth", color: "var(--accent)" },
      { key: "healthA", color: "var(--green)" },
      { key: "healthB", color: "var(--purple)" },
    ];
    for (var li = 0; li < lines.length; li++) {
      var path = "M";
      for (var i = 0; i < n; i++) {
        var x = pad + i * stepX;
        var y = pad + (1 - S.history[i][lines[li].key]) * (h - pad * 2);
    ...
    for (var i = 0; i < n; i++) {
      var x = pad + i * stepX;
      var y = pad + (1 - S.history[i].relHealth) * (h - pad * 2);
      var e = S.history[i];
      svg +=
        '<circle cx="' +
        rnd(x, 1) +
        '" cy="' +
        rnd(y, 1) +
        '" r="4" fill="var(--accent)" opacity="0.7" ' +
        'data-tip="' +
        e.label +
        " | " +
        e.category +
  ...
  function showEventSummary(result) {
    ...
    if (!el) return;
    var h =
      "<strong>" + result.action + "</strong> @ " + pct(result.intensity) + "%";
    h +=
      "<br>Vulnerability: " +
      result.vulnScale +
      "x | Fragility: " +
      result.fragScale +
      "x | Conflict: Lv" +
      Math.round(result.conflictLevel);
    var sections = [
      {
        label: S[result.actor].name + " (Self)",
        data: result.selfImpact,
        color: "var(--accent)",
      },
      {
        label: S[result.receiver].name + " (Partner ×" + result.vulnScale + ")",
        data: result.partnerImpact,
        color: "var(--purple)",
      },
      {
        label: "Relationship (×" + result.fragScale + ")",
        data: result.relImpact,
        color: "var(--yellow)",
      },
    ];
  ...
  function applyPractice(who, idx) {
    ...
    var other = who === "a" ? "b" : "a";
    if (p.effects) {
      var ek = Object.keys(p.effects);
      for (var i = 0; i < ek.length; i++) {
        if (S[who][ek[i]] !== undefined)
          S[who][ek[i]] = cl(S[who][ek[i]] + p.effects[ek[i]]);
      }
    }
    if (p.partnerEffects) {
      var pk = Object.keys(p.partnerEffects);
      for (var i = 0; i < pk.length; i++) {
        if (S[other][pk[i]] !== undefined)
          S[other][pk[i]] = cl(S[other][pk[i]] + p.partnerEffects[pk[i]]);
      }
    }
    if (p.relEffects) {
      var rk = Object.keys(p.relEffects);
      for (var i = 0; i < rk.length; i++) {
        if (S.rel[rk[i]] !== undefined)
          S.rel[rk[i]] = cl(S.rel[rk[i]] + p.relEffects[rk[i]]);
      }
    }
    calcHealth(who);
    calcHealth(other);
    calcRelHealth();
    S.sentHistory.push(1);
    S.evtCount++;
  ...
  function applyToxic(who, idx) {
    ...
    var other = who === "a" ? "b" : "a";
    if (t.effects) {
      var ek = Object.keys(t.effects);
      for (var i = 0; i < ek.length; i++) {
        if (S[who][ek[i]] !== undefined)
          S[who][ek[i]] = cl(S[who][ek[i]] + t.effects[ek[i]]);
      }
    }
    if (t.partnerEffects) {
      var pk = Object.keys(t.partnerEffects);
      for (var i = 0; i < pk.length; i++) {
        if (S[other][pk[i]] !== undefined)
          S[other][pk[i]] = cl(S[other][pk[i]] + t.partnerEffects[pk[i]]);
      }
    }
    if (t.relEffects) {
      var rk = Object.keys(t.relEffects);
      for (var i = 0; i < rk.length; i++) {
        if (S.rel[rk[i]] !== undefined)
          S.rel[rk[i]] = cl(S.rel[rk[i]] + t.relEffects[rk[i]]);
      }
    }
    calcHealth(who);
    calcHealth(other);
  ...
  function buildOcean(who) {
    ...
    for (var i = 0; i < traits.length; i++) {
      var t = traits[i];
      var v = Math.round((S[who].ocean[t[0]] || 0.5) * 100);
      h +=
        '<div class="ocean-item"><div class="ocean-label"><span>' +
        t[1] +
        '</span><span id="ov' +
        t[0] +
        s +
    ...
    el.querySelectorAll("input").forEach(function (inp) {
      inp.addEventListener("input", function () {
        var w = this.getAttribute("data-who");
        var t = this.getAttribute("data-trait");
  ...
  function buildMH(who) {
    ...
    if (!el) return;
    var h = "";
    for (var i = 0; i < MH_ORDER.length; i++) {
      var k = MH_ORDER[i];
      var def = MH[k];
      if (!def) continue;
      var v = S[who].mh[k] || 0;
      ...
      h +=
        '<div class="mh-item" data-tip="' +
        tip.replace(/"/g, "&quot;") +
        '"><div class="mh-label"><span>' +
        def.label +
        '</span><span id="mhv_' +
        k +
        s +
        ...
        v +
        "</span></div>" +
        '<input type="range" min="0" max="9" value="' +
        v +
        '" class="slider" data-who="' +
        who +
        '" data-key="' +
  ...
  function buildPractBtns(who) {
    var s = who === "a" ? "A" : "B";
    var el = $("practiceButtons" + s);
    if (!el) return;
    var h = "";
    for (var i = 0; i < PRACTICES.length; i++) {
      h +=
        '<button class="btn" data-who="' +
        who +
        '" data-idx="' +
        i +
        '" data-tip="' +
  ...
  function buildToxBtns(who) {
    var s = who === "a" ? "A" : "B";
    var el = $("toxicButtons" + s);
    if (!el) return;
    var h = "";
    for (var i = 0; i < TOXICS.length; i++) {
      h +=
        '<button class="btn btn-danger" data-who="' +
        who +
        '" data-idx="' +
        i +
        '">' +
  ...
  function populateCats(selId) {
    ...
    for (var i = 0; i < CAT_ORDER.length; i++) {
      el.innerHTML +=
        '<option value="' + CAT_ORDER[i] + '">' + CAT_ORDER[i] + "</option>";
    }
  }
  ...
  function populateScens(catKey, selId) {
    ...
    for (var i = 0; i < cat.scenarios.length; i++) {
      el.innerHTML +=
        '<option value="' + i + '">' + cat.scenarios[i].label + "</option>";
    }
  }
  ...
  function readUI() {
    ...
    var ha = $("hdA");
    if (ha) ha.textContent = S.a.name;
    var hb = $("hdB");
    if (hb) hb.textContent = S.b.name;
  }

  // ── APPLY STARTING CONDITION ──
  function applyStart() {
    var cond = START[S.startCond];
    if (!cond) return;
    var keys = Object.keys(cond);
    for (var i = 0; i < keys.length; i++) {
      if (keys[i] !== "label" && S.rel[keys[i]] !== undefined)
        S.rel[keys[i]] = cond[keys[i]];
    }
  }
  ...
  function renderAll() {
    ...
    renderIndMetrics("b");
    renderRelMetrics();
    renderRadar("radarA", "a");
    renderRadar("radarB", "b");
    renderStory("a");
    renderStory("b");
    renderNarrative();
    renderRecs();
    renderTimeline();
    renderLog("logA", S.logA);
    renderLog("logB", S.logB);
    renderLog("relLog", S.log);
  }
  // ── TOOLTIP SYSTEM ──
  ...
  function initDisclaimer() {
    var ov = $("disclaimerOverlay");
    if (!ov) return;
    if (localStorage.getItem("novus_disc_v3") === "1") {
      ov.classList.add("dismissed");
      showApp();
      return;
    }
    var cb = $("disclaimerCB");
    var btn = $("disclaimerBtn");
    if (!cb || !btn) return;
  ...
  function initIB() {
    ...
    if (catSel)
      catSel.addEventListener("change", function () {
        populateScens(this.value, "ibScen");
        updateIBState();
      });
    if (scenSel)
      scenSel.addEventListener("change", function () {
        ...
        if (cat && this.value !== "") {
          var sc = cat.scenarios[parseInt(this.value)];
          if (sc && intSlider) {
            intSlider.value = Math.round(sc.int * 100);
            if (intVal) intVal.textContent = Math.round(sc.int * 100);
          }
        }
        updateIBState();
      });
    if (intSlider)
      intSlider.addEventListener("input", function () {
        if (intVal) intVal.textContent = this.value;
      });
    ...
    if (goBtn)
      goBtn.addEventListener("click", function () {
        ...
        var scen = parseInt(scenSel.value);
        var inten = parseInt(intSlider.value) / 100;
        if (!cat || isNaN(scen)) return;
        processInteraction(dir, cat, scen, inten);
        var chain = $("ibChain");
        if (chain) chain.style.display = "block";
      });

    // Chain
    var ccSel = $("ibChainCat");
    var csSel = $("ibChainScen");
    var cBtn = $("ibChainGo");
    var cInt = $("ibChainInt");
    var cIntVal = $("ibChainIntVal");
    if (ccSel)
      ccSel.addEventListener("change", function () {
        populateScens(this.value, "ibChainScen");
        updateChainState();
      });
    if (csSel)
    ...
    if (cInt)
      cInt.addEventListener("input", function () {
        if (cIntVal) cIntVal.textContent = this.value;
      });
    function updateChainState() {
      if (cBtn)
        cBtn.disabled = !(ccSel && ccSel.value && csSel && csSel.value !== "");
    }
    if (cBtn)
  ...
  function initMoment() {
    ...
    if (mc)
      mc.addEventListener("change", function () {
        populateScens(this.value, "momScen");
        updateMomState();
      });
    if (ms)
    ...
    if (mi)
      mi.addEventListener("input", function () {
        if (miv) miv.textContent = this.value;
      });
    function updateMomState() {
      var ready = mc && mc.value && ms && ms.value !== "";
      if (mp) mp.disabled = !ready;
      if (mr) mr.disabled = !ready;
    }
    if (mp)
      mp.addEventListener("click", function () {
        var cat = mc.value;
        var scen = parseInt(ms.value);
        var inten = parseInt(mi.value) / 100;
        if (!cat || isNaN(scen)) return;
        var catD = INTERACTIONS[cat];
        var sc = catD.scenarios[scen];
        var recv = $("momDir")
          ? $("momDir").value === "AtoB"
            ? "b"
            : "a"
          : "b";
        var vuln = calcVuln(recv);
        var frag = calcFrag();
        var res = $("momResult");
        if (!res) return;
        var h =
          ...
          "x | Frag: " +
          rnd(frag, 2) +
          "x<br><strong>Expected:</strong> ";
        var bk = Object.keys(catD.base);
        for (var i = 0; i < bk.length; i++) {
          var v = catD.base[bk[i]] * inten * 2 * frag;
  ...
  function saveSession() {
    try {
      var d = clone(S);
      delete d.undoStack;
      localStorage.setItem("novus_v3", JSON.stringify(d));
      addLog("Session saved.", "rel");
    } catch (e) {}
  }
  function loadSession() {
    try {
      var raw = localStorage.getItem("novus_v3");
      if (!raw) return;
      ...
      S.undoStack = [];
      renderAll();
      addLog("Session loaded.", "rel");
    } catch (e) {}
  }
  function exportReport() {
    var lines = [
      "NOVUS LOVE v3 — SESSION REPORT",
    ...
    lines.push(
      "RELATIONSHIP: " +
        pct(S.rel.overall) +
        "% | " +
        getTier(S.rel.overall, REL_TIERS).label,
    );
    var st = classifySternberg(
      S.rel.sternIntimacy,
      S.rel.passion,
      S.rel.commitment,
    );
    ...
    for (var i = 0; i < S.log.length; i++)
      lines.push("[" + S.log[i].time + "] " + S.log[i].msg);
    var blob = new Blob([lines.join("\n")], { type: "text/plain" });
    var url = URL.createObjectURL(blob);
    var a = document.createElement("a");
    a.href = url;
    a.download = "novus-report-" + Date.now() + ".txt";
  ...
  function renderCompare() {
    ...
    if (!el) return;
    if (!S.snapshot) {
      el.innerHTML = "Take a snapshot first.";
      return;
    }
    var snap = S.snapshot;
    var h =
      '<table style="width:100%;border-collapse:collapse;font-size:.8rem"><tr><th style="text-align:left;padding:4px;border-bottom:1px solid var(--border)">Metric</th><th>Snapshot</th><th>Current</th><th>Change</th></tr>';
    var rk = [
      "safety",
      "trust",
      "bond",
    ...
    for (var i = 0; i < rk.length; i++) {
      var k = rk[i];
      var old = snap.rel[k] || 0;
      var cur = S.rel[k] || 0;
      var diff = rnd(cur - old, 3);
      var clr =
        diff > 0 ? "var(--green)" : diff < 0 ? "var(--red)" : "var(--dim)";
      if (k === "tension" || k === "friction")
        clr =
          diff > 0 ? "var(--red)" : diff < 0 ? "var(--green)" : "var(--dim)";
      h +=
  ...
  function initWhitepaper() {
    ...
    if (!el) return;
    el.innerHTML =
      "<h4>Novus Love v3 — Model Reference</h4>" +
  ...
  function initBottomBar() {
    ...
    if (run)
      run.addEventListener("click", function () {
        readUI();
        applyStart();
        var mhA = calcMHImpact("a");
        var mhB = calcMHImpact("b");
        ...
        calcRelHealth();
        renderAll();
        addLog("Engine initialized — " + S.a.name + " & " + S.b.name, "rel");
        playTone("pos");
      });
    ...
    if ($("mbtiA"))
      $("mbtiA").addEventListener("change", function () {
        setOceanFromMBTI("a");
      });
    if ($("mbtiB"))
      $("mbtiB").addEventListener("change", function () {
        setOceanFromMBTI("b");
      });
  }
  ...
  document.addEventListener("DOMContentLoaded", function () {
    initDisclaimer();
    if (!document.querySelector(".disclaimer-overlay:not(.dismissed)"))
      initApp();
    else {
      var obs = new MutationObserver(function (muts) {
        for (var i = 0; i < muts.length; i++) {
          if (
            ...
            muts[i].target.classList.contains("dismissed")
          ) {
            initApp();
            obs.disconnect();
            return;
